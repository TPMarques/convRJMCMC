...
plot.CZ_ANOVA<-function(x,...){
  ...
  plot(xv,PSRF1,type="l",ylim=ylim,xlab="Lote",ylab="Crit?rio",main=NULL)
  ...
  layout(matrix(c(1,2),nrow=2),heights = c(1,0.1))
  par(mar=c(5.1,5.1,4.1,2.1))
  plot(xv,Wm,type="l",ylim=ylim,xlab="Lote",ylab="Crit?rio",main=NULL)
  lines(xv,Wcm,lty=3)
  par(mar=c(rep(0,4)))
  plot(0,0,type="n",bty="n",xaxt="n",yaxt="n")
...
plot.CZ_MANOVA<-function(x,...){
  ...
  plot(xv,MPSRF1,type="l",ylim=ylim,xlab="Lote",ylab="Crit?rio",main=NULL)
